...
<center>
    ...
    <div class="container">
        ...
        <input type="submit" value="Next" class="btn btn-warning" name="_eventId_shippingDetailCollected" />

        <button class="btn btn-success" name="_eventId_cancel">Cancel</button>
